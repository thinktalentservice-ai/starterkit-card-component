...
underlying node. A card that swallows its ref silently breaks every one.`,methods:[],displayName:`Card`}})),g=e((()=>{h(),l()})),_=e((()=>{}));function v(e){let t=[];for(let n of T){let r=e[n];r!==void 0&&t.push(`${n}="${r}"`)}for(let n of E)e[n]&&t.push(n);return`<Card${t.length>0?` ${t.join(` `)}`:``}>${e.children}</Card>`}function y(e){let t=document.createElement(`textarea`);t.value=e,t.setAttribute(`readonly`,``),t.style.position=`fixed`,t.style.opacity=`0`,document.body.appendChild(t),t.select(),document.execCommand(`copy`),document.body.removeChild(t)}function b({inverse:e=!1,...t}){let n=v(t),[r,i]=(0,C.useState)(!1),a=(0,C.useRef)(void 0);(0,C.useEffect)(()=>()=>clearTimeout(a.current),[]);let o=async()=>{try{await navigator.clipboard.writeText(n)}catch{y(n)}i(!0),clearTimeout(a.current),a.current=setTimeout(()=>i(!1),1200)},{children:s,body:c,href:l,...u}=t;return(0,w.jsxs)(`article`,{className:`ic-specimen`,"data-inverse":e||void 0,children:[(0,w.jsx)(`div`,{className:`ic-specimen__stage`,children:l===void 0?(0,w.jsxs)(m,{...u,children:[s,c]}):(0,w.jsxs)(m,{href:l,...u,children:[s,c]})}),(0,w.jsxs)(`button`,{type:`button`,onClick:o,className:`ic-specimen__code`,"data-copied":r||void 0,"aria-label":`Copy code: ${n}`,children:[(0,w.jsxs)(`span`,{className:`ic-specimen__code-meta`,"aria-hidden":`true`,children:[(0,w.jsx)(`span`,{children:`JSX`}),(0,w.jsx)(`span`,{className:`ic-specimen__copy-state`,children:r?(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(S,{}),`Copied`]}):(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(x,{}),`Copy`]})})]}),(0,w.jsx)(`code`,{children:n}),(0,w.jsx)(`span`,{className:`ic-visually-hidden`,"aria-live":`polite`,children:r?`Code copied to clipboard`:``})]})]})}function x(){return(0,w.jsxs)(`svg`,{viewBox:`0 0 16 16`,"aria-hidden":`true`,children:[(0,w.jsx)(`rect`,{x:`5.25`,y:`5.25`,width:`7.5`,height:`7.5`,rx:`1.5`}),(0,w.jsx)(`path`,{d:`M10.75 5.25V4A1.75 1.75 0 0 0 9 2.25H4A1.75 1.75 0 0 0 2.25 4v5A1.75 1.75 0 0 0 4 10.75h1.25`})]})}function S(){return(0,w.jsx)(`svg`,{viewBox:`0 0 16 16`,"aria-hidden":`true`,children:(0,w.jsx)(`path`,{d:`m3 8.25 3.1 3.1L13 4.65`})})}var C,w,T,E,D=e((()=>{C=t(n(),1),h(),_(),w=r(),T=[`variant`,`tone`,`fill`,`pad`,`accent`,`href`],E=[`interactive`,`noBorder`,`fullHeight`,`disabled`],b.__docgenInfo={description:`One card plus the exact JSX that produced it. Click the code to copy it.`,methods:[],displayName:`Swatch`,props:{variant:{required:!1,tsType:{name:`unknown`},description:``},tone:{required:!1,tsType:{name:`union`,raw:`"mint" | "violet" | "amber" | "danger" | "blue" | "neutral"`,elements:[{name:`literal`,value:`"mint"`},{name:`literal`,value:`"violet"`},{name:`literal`,value:`"amber"`},{name:`literal`,value:`"danger"`},{name:`literal`,value:`"blue"`},{name:`literal`,value:`"neutral"`}]},description:``},fill:{required:!1,tsType:{name:`union`,raw:`"glass" | "surface" | "elevated" | "gradient" | "outline"`,elements:[{name:`literal`,value:`"glass"`},{name:`literal`,value:`"surface"`},{name:`literal`,value:`"elevated"`},{name:`literal`,value:`"gradient"`},{name:`literal`,value:`"outline"`}]},description:``},pad:{required:!1,tsType:{name:`union`,raw:`"none" | "sm" | "md" | "lg"`,elements:[{name:`literal`,value:`"none"`},{name:`literal`,value:`"sm"`},{name:`literal`,value:`"md"`},{name:`literal`,value:`"lg"`}]},description:``},accent:{required:!1,tsType:{name:`string`},description:``},href:{required:!1,tsType:{name:`string`},description:``},interactive:{required:!1,tsType:{name:`boolean`},description:``},noBorder:{required:!1,tsType:{name:`boolean`},description:``},fullHeight:{required:!1,tsType:{name:`boolean`},description:``},disabled:{required:!1,tsType:{name:`boolean`},description:``},children:{required:!0,tsType:{name:`string`},description:`Restricted to a string so the printed snippet is always the literal JSX.`},body:{required:!1,tsType:{name:`ReactNode`},description:`Story-only scaffolding rendered inside the card. Never printed.`},inverse:{required:!1,tsType:{name:`boolean`},description:``,defaultValue:{value:`false`,computed:!1}}}}})),O=e((()=>{}));function k({title:e,description:t,children:n}){return(0,j.jsxs)(`section`,{className:`ic-story-section`,children:[(0,j.jsx)(`div`,{className:`ic-story-section__header`,children:(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`h3`,{className:`ic-story-section__title`,children:e}),t?(0,j.jsx)(`p`,{className:`ic-story-section__description`,children:t}):null]})}),n]})}function A({title:e,description:t,children:n}){return(0,j.jsxs)(`main`,{className:`ic-story`,children:[(0,j.jsxs)(`header`,{className:`ic-story__hero`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`p`,{className:`ic-story__eyebrow`,children:`IC / component specimen`}),(0,j.jsx)(`h2`,{className:`ic-story__title`,children:e}),(0,j.jsx)(`p`,{className:`ic-story__lede`,children:t})]}),(0,j.jsxs)(`div`,{className:`ic-story__axes`,"aria-label":`Card design axes`,children:[(0,j.jsx)(`span`,{children:`tone`}),(0,j.jsx)(`span`,{children:`fill`}),(0,j.jsx)(`span`,{children:`pad`})]})]}),(0,j.jsx)(`div`,{className:`ic-story__body`,children:n})]})}var j,M,N,P,F,I,L,R,z,B,V,H,U,W;e((()=>{g(),D(),O(),j=r(),M=[`mint`,`violet`,`amber`,`danger`,`blue`,`neutral`],N=[`glass`,`surface`,`elevated`,`gradient`,`outline`],P=[`none`,`sm`,`md`,`lg`],F=Object.keys(o),I={title:`Components/Card`,component:m,tags:[`autodocs`],parameters:{docs:{description:{component:"A token-driven container with independent tone, fill, and pad axes. Pass `href` to render an anchor, `onClick` to get button semantics; explicit axis props override named presets.\n\nEvery card below prints its own JSX underneath it — click the code to copy it. The story-level **Show code** panel shows the surrounding loop, so the per-card snippet is the one to copy."}}},args:{children:`Quarterly revenue`,pad:`md`,noBorder:!1,fullHeight:!1,disabled:!1},argTypes:{tone:{control:`select`,options:M,description:`Colour identity.`},fill:{control:`select`,options:N,description:`How the tone is applied to the surface.`},pad:{control:`inline-radio`,options:P,description:`Inner padding scale.`},variant:{control:`select`,options:[void 0,...F],description:`Named preset. Explicit axis props take precedence.`},accent:{control:`text`,description:`Top accent strip. Any CSS colour string.`},href:{control:`text`,description:`When set, renders an anchor instead of a div.`},interactive:{control:`boolean`,description:`Hover/focus lift. Defaults to on for a clickable card.`},as:{control:!1},children:{control:`text`}}},L={render:({children:e,variant:t,tone:n,fill:r,pad:i,accent:a,href:o,interactive:s,noBorder:c,fullHeight:l,disabled:u})=>(0,j.jsx)(A,{title:`Card workbench`,description:`Tune the axes in Controls. The specimen and its paste-ready JSX update together.`,children:(0,j.jsx)(k,{title:`Live specimen`,description:`Click the dark code panel to copy this exact setup.`,children:(0,j.jsx)(`div`,{className:`ic-story-grid`,children:(0,j.jsx)(b,{variant:t,tone:n,fill:r,pad:i,accent:a,href:o,interactive:s,noBorder:c,fullHeight:l,disabled:u,children:typeof e==`string`?e:`Quarterly revenue`})})})})},R={render:()=>(0,j.jsx)(A,{title:`Preset index`,description:`The seven names the starterkit's own Card shipped, plus the two the axis split made free. Convenience aliases only — never a separate styling API.`,children:(0,j.jsx)(k,{title:`Named presets`,description:`Each resolves to the same orthogonal axes shown in Controls.`,children:(0,j.jsx)(`div`,{className:`ic-story-grid`,children:F.map(e=>(0,j.jsx)(b,{variant:e,children:e},e))})})})},z={render:()=>(0,j.jsx)(A,{title:`Tone × fill atlas`,description:`Every surface treatment against every colour identity. The old variant list could only reach the diagonal.`,children:N.map(e=>(0,j.jsx)(k,{title:e,description:e===`gradient`?"neutral publishes no gradient, so that one cell degrades to `surface` rather than rendering an invisible box.":void 0,children:(0,j.jsx)(`div`,{className:`ic-story-grid`,children:M.map(t=>(0,j.jsx)(b,{tone:t,fill:e,children:t},t))})},e))})},B={render:()=>(0,j.jsx)(A,{title:`Padding scale`,description:"Inner rhythm, independent of colour. `none` exists for media cards, where an image has to bleed to the corners.",children:(0,j.jsx)(k,{title:`pad`,children:(0,j.jsx)(`div`,{className:`ic-story-grid`,children:P.map(e=>(0,j.jsx)(b,{pad:e,fill:`surface`,children:e},e))})})})},V={render:()=>(0,j.jsxs)(A,{title:`Behaviour states`,description:`Lift, accent, links and the dead state as real interactive elements — not static approximations. Tab through them: focus gets the same treatment as hover.`,children:[(0,j.jsx)(k,{title:`Interaction`,description:`A static card never lifts; a clickable one opts in automatically.`,children:(0,j.jsxs)(`div`,{className:`ic-story-grid`,children:[(0,j.jsx)(b,{fill:`surface`,children:`Static`}),(0,j.jsx)(b,{fill:`surface`,interactive:!0,children:`Lifts on hover`}),(0,j.jsx)(b,{href:`#card-link`,fill:`surface`,children:`Anchor card`}),(0,j.jsx)(b,{href:`#dead-link`,fill:`surface`,disabled:!0,children:`Disabled anchor`})]})}),(0,j.jsx)(k,{title:`Accent strip`,description:`Drawn as a pseudo-element so a hover border-color change cannot wipe it.`,children:(0,j.jsxs)(`div`,{className:`ic-story-grid`,children:[(0,j.jsx)(b,{fill:`glass`,accent:`#4DB3FF`,interactive:!0,children:`Cobalt accent`}),(0,j.jsx)(b,{fill:`glass`,accent:`#B3D335`,interactive:!0,children:`Mint accent`}),(0,j.jsx)(b,{fill:`surface`,accent:`#f43f5e`,noBorder:!0,children:`Accent, no border`})]})})]})},H={render:()=>(0,j.jsx)(A,{title:`Context surfaces`,description:`Glass is the one fill whose whole point is what shows through it — so it is shown over an expressive surface rather than a flat page.`,children:(0,j.jsx)(`div`,{className:`ic-story-context`,children:(0,j.jsx)(k,{title:`Glass over a gradient`,description:`The vendored defaults are dark-first; this is the surface they were tuned for.`,children:(0,j.jsxs)(`div`,{className:`ic-story-grid`,children:[(0,j.jsx)(b,{fill:`glass`,inverse:!0,interactive:!0,children:`Glass`}),(0,j.jsx)(b,{fill:`outline`,tone:`mint`,inverse:!0,interactive:!0,children:`Outline`}),(0,j.jsx)(b,{fill:`gradient`,tone:`blue`,inverse:!0,interactive:!0,children:`Gradient`})]})})})})},U={render:()=>(0,j.jsx)(A,{title:`Composition`,description:`A KPI card and a feature card are Card plus content. Neither needs a new variant.`,children:(0,j.jsx)(k,{title:`Built from the primitive`,children:(0,j.jsxs)(`div`,{className:`ic-story-grid`,children:[(0,j.jsxs)(m,{fill:`glass`,accent:`#4DB3FF`,interactive:!0,children:[(0,j.jsx)(`p`,{className:`ic-demo-eyebrow`,children:`Monthly recurring`}),(0,j.jsx)(`p`,{className:`ic-demo-value`,children:`$48.2k`}),(0,j.jsx)(`p`,{className:`ic-demo-sub`,children:`vs $41.9k last month`})]}),(0,j.jsxs)(m,{fill:`gradient`,tone:`blue`,children:[(0,j.jsx)(`p`,{className:`ic-demo-eyebrow`,children:`Featured`}),(0,j.jsx)(`p`,{className:`ic-demo-title`,children:`Automated reconciliation`}),(0,j.jsx)(`p`,{className:`ic-demo-body`,children:`Matches ledger entries against settlement files, then flags only what disagrees.`})]}),(0,j.jsxs)(m,{as:`article`,fill:`outline`,tone:`mint`,interactive:!0,children:[(0,j.jsx)(`p`,{className:`ic-demo-eyebrow`,children:`Semantic`}),(0,j.jsx)(`p`,{className:`ic-demo-title`,children:`as="article"`}),(0,j.jsx)(`p`,{className:`ic-demo-body`,children:`The wrapper element is a prop, so a card in a feed can be an article and a card in a list can be an li.`})]})]})})})},L.parameters={...L.parameters,docs:{...L.parameters?.docs,source:{originalSource:`{
  ...
  render: () => <StoryFrame title="Preset index" description="The seven names the starterkit's own Card shipped, plus the two the axis split made free. Convenience aliases only — never a separate styling API.">\r
  ...
  render: () => <StoryFrame title="Tone × fill atlas" description="Every surface treatment against every colour identity. The old variant list could only reach the diagonal.">\r
  ...
  render: () => <StoryFrame title="Behaviour states" description="Lift, accent, links and the dead state as real interactive elements — not static approximations. Tab through them: focus gets the same treatment as hover.">\r
      ...
      <Section title="Accent strip" description="Drawn as a pseudo-element so a hover border-color change cannot wipe it.">\r
        <div className="ic-story-grid">\r
          <Swatch fill="glass" accent="#4DB3FF" interactive>\r
            Cobalt accent\r
          </Swatch>\r
          <Swatch fill="glass" accent="#B3D335" interactive>\r
            Mint accent\r
          </Swatch>\r
  ...
  render: () => <StoryFrame title="Context surfaces" description="Glass is the one fill whose whole point is what shows through it — so it is shown over an expressive surface rather than a flat page.">\r
      <div className="ic-story-context">\r
        <Section title="Glass over a gradient" description="The vendored defaults are dark-first; this is the surface they were tuned for.">\r
          <div className="ic-story-grid">\r
            <Swatch fill="glass" inverse interactive>\r
              Glass\r
            </Swatch>\r
            <Swatch fill="outline" tone="mint" inverse interactive>\r
              Outline\r
            </Swatch>\r
            <Swatch fill="gradient" tone="blue" inverse interactive>\r
              Gradient\r
            </Swatch>\r
          </div>\r
        </Section>\r
  ...
  render: () => <StoryFrame title="Composition" description="A KPI card and a feature card are Card plus content. Neither needs a new variant.">\r
      <Section title="Built from the primitive">\r
        <div className="ic-story-grid">\r
          <Card fill="glass" accent="#4DB3FF" interactive>\r
          ...
          <Card fill="gradient" tone="blue">\r
          ...
          <Card as="article" fill="outline" tone="mint" interactive>\r
...
}`,...U.parameters?.docs?.source},description:{story:`The KPI and feature cards in the starterkit are compositions, not variants —\r
...
and baking them in would put the library back in the business of guessing.`,...U.parameters?.docs?.description}}},W=[`Playground`,`Presets`,`AxisMatrix`,`Padding`,`States`,`OnAColouredSurface`,`Composition`]}))();export{z as AxisMatrix,U as Composition,H as OnAColouredSurface,B as Padding,L as Playground,R as Presets,V as States,W as __namedExportsOrder,I as default};